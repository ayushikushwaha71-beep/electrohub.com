...
import { RFQEntryButton } from '@/components/rfq/RFQEntryButton';
...
export function PurchaseSection({ product, className }: PurchaseSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* ── Request a Quote — additive only, existing code above is unchanged ── */}
      <div className="pt-1">
        <RFQEntryButton product={product} quantity={quantity} size="lg" />
      </div>
    </motion.div>
  );
}
